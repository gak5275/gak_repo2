...
DHmediaPath = os.path.join(workingDir, 'DHmedia')
print(DHmediaPath)
...
allDocs = []
for file in os.listdir(DHmediaPath):
    if file.endswith(".txt"):
        filepath = f"{DHmediaPath}/{file}"
        # print(filepath)
...
sorted_topics = sorted(topics[31], key=lambda x: x[1], reverse=True)
